...
import {Box, IconButton, Modal, Button, InputAdornment, Typography, Grid, Avatar, Badge, Divider, TextField} from '@mui/material';
import {Edit, Email, ToggleOffRounded, EmailOutlined, AccountCircleRounded, CameraAltRounded, GroupsRounded, ContactsRounded, Settings, LogoutRounded, Close} from '@mui/icons-material';
                ...
                <Grid container>
                    ...
                    <Grid item xs={2}>
                        <IconButton aria-label='Edit' sx={{p:0}}>
                            <ToggleOffRounded sx={{fontSize:'35px',my:'-8px', mt:'-10px',color:'#154017'}}/>
                        </IconButton>
                    </Grid>
                </Grid>
                <Divider sx={{my:2}}/>
